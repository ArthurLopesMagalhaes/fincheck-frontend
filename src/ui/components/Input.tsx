    ...
    return (
      <div className="relative">
        <input
          ...
          {...props}
          className={cn(
            "bg-white w-full pt-4 rounded-lg border border-gray-500 px-3 h-[52px] text-gray-800 peer placeholder-shown:pt-0 focus:border-gray-800 transition-all outline-none",
